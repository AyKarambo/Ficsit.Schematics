...
public static class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        // Canvas rendering + interaction: the controller drives the drawable, both
        // injected into MainPage rather than hand-wired there.
        builder.Services.AddSingleton<FactoryCanvasDrawable>();
        builder.Services.AddSingleton<CanvasController>();
