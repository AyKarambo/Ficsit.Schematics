...
public sealed class BiomassBurnerRecipes : RecipeModule
{
    ...
    [
        new( 21, "Leaves Biomass Burner",                  Batch: "1/2",  Tier: "0-6", [In("Leaves", 1)], IgnoreInputMultiplier: true),
        new( 28, "Mycelia Biomass Burner",                 Batch: "2/3",  Tier: "0-6", [In("Mycelia", 1)], IgnoreInputMultiplier: true),
        new( 29, "Wood Biomass Burner",                    Batch: "10/3", Tier: "0-6", [In("Wood", 1)], IgnoreInputMultiplier: true),
