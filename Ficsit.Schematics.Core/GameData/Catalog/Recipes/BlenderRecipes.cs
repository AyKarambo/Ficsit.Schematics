...
public sealed class BlenderRecipes : RecipeModule
{
    ...
    [
        ...
        new(183, "Nitro Rocket Fuel",    Batch: R("12/5"), Tier: "8-3", [In("Fuel", 4), In("Nitrogen Gas", 3), In("Sulfur", 4), In("Coal", 2), Out("Rocket Fuel", 6), Out("Compacted Coal", 1)], Alternate: true),
        ...
        new(234, "Battery",              Batch: 3,         Tier: "7-5", [In("Sulfuric Acid", R("5/2")), In("Alumina Solution", 2), In("Aluminum Casing", 1), Out("Battery", 1), Out("Water", R("3/2"))]),
