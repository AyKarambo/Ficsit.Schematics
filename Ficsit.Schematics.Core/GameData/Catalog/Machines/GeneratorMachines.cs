...
public sealed class GeneratorMachines : MachineModule
{
    ...
    [
        ...
        Machine(21, "Geothermal Generator", "6-1", power: "200", minPower: "100", overclockExp: null,
            ...
            [
                Cap("Impure", color: 13775920, powerRatio: "1/2"),
                Cap("Normal", isDefault: true),
                Cap("Pure", color: 8433977, powerRatio: "2"),
            ]),

        // Boosts grid power rather than generating from a fuel recipe.
        Machine(28, "Alien Power Augmenter", "9-1", basePower: "500", basePowerBoost: "1/10",
                fueledBasePowerBoost: "3/10", overclockExp: null,
