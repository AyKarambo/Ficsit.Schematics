...
public sealed class ProductionMachines : MachineModule
{
    ...
    [
        Machine(2,  "Constructor", "0-3", power: -4, overclockExp: StandardOverclock,
                sloops: 1, sloopMultiplier: 1, sloopPowerExp: 2,
                cost: [C("Reinforced Iron Plate", 2), C("Cable", 8)]),
        Machine(7,  "Assembler", "2-1", power: -15, overclockExp: StandardOverclock,
                sloops: 2, sloopMultiplier: R("1/2"), sloopPowerExp: 2,
                cost: [C("Reinforced Iron Plate", 8), C("Rotor", 4), C("Cable", 10)]),
        Machine(15, "Refinery", "5-2", power: -30, overclockExp: StandardOverclock,
                sloops: 2, sloopMultiplier: R("1/2"), sloopPowerExp: 2,
                cost: [C("Motor", 10), C("Encased Industrial Beam", 10), C("Steel Pipe", 30), C("Copper Sheet", 20)]),
        Machine(17, "Packager", "5-4", power: -10, overclockExp: StandardOverclock,
                cost: [C("Steel Beam", 20), C("Rubber", 10), C("Plastic", 10)]),
        Machine(20, "Manufacturer", "6-1", power: -55, overclockExp: StandardOverclock,
                sloops: 4, sloopMultiplier: R("1/4"), sloopPowerExp: 2,
                cost: [C("Motor", 10), C("Modular Frame", 20), C("Plastic", 50), C("Cable", 50)]),
        Machine(22, "Blender", "7-5", power: -75, overclockExp: StandardOverclock,
                sloops: 4, sloopMultiplier: R("1/4"), sloopPowerExp: 2,
