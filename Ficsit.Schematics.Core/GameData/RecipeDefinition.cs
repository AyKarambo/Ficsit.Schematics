...
public sealed class RecipeDefinition
{
    ...
    public string BatchTime { get; set; } = "60";
    ...
    /// <summary>Per-recipe Space Elevator cost multiplier flag.</summary>
    ...
    public Rational BatchTimeValue => Rational.Parse(BatchTime);
